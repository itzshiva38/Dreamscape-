...
const NOTES_AUTH_KEY = "dreamscape-notes-unlocked";
const CORRECT_PASSWORD = "iwannabeyoursforever";

const dreamscapeNotes = [
...
export default function DreamscapeBook({ open, onClose }: Props) {
