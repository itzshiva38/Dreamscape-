...
const CORRECT_PASSWORD = "iloveyou2716";
...
export default function DreamscapePasswordGate({ onUnlock, fadeOut }: Props) {
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg">
            A special place for my one and only love 💕\
          </p>
        </motion.div>
        ...
        <AnimatePresence>
          {showHint && (
            ...
            >
              The day we started our forever journey together 💕
            </motion.p>
          )}\
        </AnimatePresence>
      </motion.div>
