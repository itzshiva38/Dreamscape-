...
import DreamscapeBook from "./dreamscape/DreamscapeBook";
...
export default function DreamJournal() {
  ...
  return (
    <section id="journal" className="relative py-24 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button onClick={() => setShowBook(true)} className="glass-button glow-border-rose text-sm flex items-center gap-2">
              <BookOpen className="h-4 w-4" /> Open Book
            </button>
          </div>
        </motion.div>
      ...
      <DreamscapeBook open={showBook} onClose={() => setShowBook(false)} />
    </section>
  );
}
